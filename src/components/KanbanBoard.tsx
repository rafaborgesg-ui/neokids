...
export default function KanbanBoard({ accessToken }: KanbanBoardProps) {
  const { appointments, loading, fetchAppointments, setAppointments } = useAppointments(accessToken)
  ...
  const filterAppointments = () => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(appointment => 
        ...
        (appointment.sampleIds && appointment.sampleIds.some(id => id.toLowerCase().includes(searchQuery.toLowerCase())))
      )
    }
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-1">
                              {appointment.sampleIds && appointment.sampleIds.slice(0, 3).map((sampleId) => (
                              ...
                              {appointment.sampleIds && appointment.sampleIds.length > 3 && (
